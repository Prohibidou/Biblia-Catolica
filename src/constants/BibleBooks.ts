export const BIBLE_BOOKS = [
    ...
    { id: 'TOB', name: 'Tobías', chapters: 14 },
    { id: 'JDT', name: 'Judit', chapters: 16 },
    { id: 'EST', name: 'Ester', chapters: 10 },
    { id: '1MA', name: '1 Macabeos', chapters: 16 },
    { id: '2MA', name: '2 Macabeos', chapters: 15 },
    ...
    { id: 'WIS', name: 'Sabiduría', chapters: 19 },
    ...
    { id: 'MAL', name: 'Malaquías', chapters: 3 },
